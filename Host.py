...
def serial_handler(ser, servo_motor, head):
    ...
    if current_min in move_list_min and current_sec in move_list_sec and current_day in move_list_day:
        ...
        # Empty first MEA
        head.move_head(ser, x=90, y=90, z=65, f=4000) # x=85, y=85, z=25, f=3000
        ...
        time.sleep(2)
        head.move_head(ser, x=90, y=90, z=65, f=4000)
        time.sleep(10)
        ...
        # Medium Load
        head.move_head(ser, x=30, y=30, z=65, f=4000)
        time.sleep(8)
        servo_motor.first_push()
        time.sleep(4)
        head.move_head(ser, x=30, y=30, z=5, f=4000)
        time.sleep(10)
        servo_motor.zero_pos()
        time.sleep(2)
        head.move_head(ser, x=30, y=30, z=65, f=4000)
        ...
        servo_motor.zero_pos()
        time.sleep(4)
        head.move_head(ser, x=140, y=90, z=65, f=4000)
        time.sleep(10)
        ...
        # Zero Pos
        head.move_head(ser, x=50, y=50, z=65, f=4000)
        servo_motor.zero_pos()
