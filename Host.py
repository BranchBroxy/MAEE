...
def serial_handler(ser, servo_motor, head):
    ...
    if current_min in move_list_min and current_sec in move_list_sec and current_day in move_list_day:
        ...
        # Empty first MEA
        head.move_head(ser, x=90, y=90, z=25, f=3000) # x=85, y=85, z=25, f=3000
        ...
        time.sleep(5)
        head.move_head(ser, x=90, y=90, z=25, f=3000)

        # Medium Dump
        head.move_head(ser, x=180, y=180, z=25, f=3000)
        ...
        time.sleep(2)
        head.move_head(ser, x=180, y=180, z=30, f=3000)
        time.sleep(2)
        servo_motor.zero_pos()
        time.sleep(2)

        # Medium Load
        head.move_head(ser, x=30, y=30, z=25, f=3000)
        time.sleep(10)
        servo_motor.first_push()
        time.sleep(5)
        ...
        servo_motor.zero_pos()
        time.sleep(2)
        head.move_head(ser, x=30, y=30, z=25, f=1500)
        time.sleep(5)
        ...
        time.sleep(5)
        head.move_head(ser, x=85, y=85, z=25, f=1500)
        time.sleep(5)
        servo_motor.zero_pos()
        time.sleep(5)
        ...
        ########### Second MEA #################
        # Empty second MEA
        head.move_head(ser, x=140, y=90, z=25, f=3000) # x=135, y=85, z=25, f=3000
        servo_motor.first_push()
        time.sleep(5)
        ...
        servo_motor.zero_pos()
        time.sleep(5)
        head.move_head(ser, x=140, y=90, z=25, f=3000)
        ...
        head.move_head(ser, x=140, y=90, z=25, f=3000)
        time.sleep(10)
        head.move_head(ser, x=140, y=90, z=10, f=1500)
        time.sleep(5)
        servo_motor.push_routine()
        time.sleep(5)
        head.move_head(ser, x=140, y=90, z=25, f=1500)
        time.sleep(5)
        servo_motor.zero_pos()
        time.sleep(5)
