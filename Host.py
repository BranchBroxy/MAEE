...
move_list_sec = ["00"]
move_list_day = ["Monday", "Wednesday", "Friday", "Saturday"]
...
def serial_handler(ser, servo_motor, head):
    ...
    if current_min in move_list_min and current_sec in move_list_sec and current_day in move_list_day:
        ...
        # Medium Dump
        head.move_head(ser, x=200, y=200, z=25, f=3000)
        head.move_head(ser, x=200, y=200, z=10, f=3000)
        time.sleep(10)
        servo_motor.first_push()
        time.sleep(5)
        ...
        # Medium Load
        head.move_head(ser, x=20, y=20, z=25, f=3000)
        time.sleep(10)
        servo_motor.first_push()
        time.sleep(5)
        ...
        servo_motor.zero_pos()
        time.sleep(2)
        head.move_head(ser, x=20, y=20, z=25, f=1500)
        time.sleep(5)
